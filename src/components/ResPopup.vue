...
<template>
  ...
  >
    ...
    <button @click="playAudio" class="absolute top-6 right-12">
      <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="20" viewBox="0 0 1261.000000 1280.000000" preserveAspectRatio="xMidYMid meet">
        <metadata>Created by potrace 1.15, written by Peter Selinger 2001-2017</metadata>
        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#99a1af" stroke="none">
          <path
    ...
    <source :src="'http://192.168.100.47/' + message.voice" type="audio/wav" />
  </div>
</template>
